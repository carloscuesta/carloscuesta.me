...
export const posts = [
  ...
  },
  {
    ...
    excerpt:
      'Creating scalable React components using the folder pattern. A simple way to organize and structure React Components.',
    html: '<h1>html</h1>',
    images: {
      featured: {
  ...
  },
  {
    ...
    excerpt:
      'The process of continuously delivering React Native apps with Fastlane and Travis CI automatically. ',
    html: '<h1>html</h1>',
    images: {
      featured: {
  ...
  },
  {
    ...
    disqusIdentifier: '23',
    excerpt:
      'ReactiveConf 2017 review. A two days conference about functional and reactive programming that takes places in Bratislava.',
    html: '<h1>html</h1>',
    images: {
      featured: {
  ...
  },
  {
    ...
    excerpt:
      'The process of moving my website and Ghost blog from Heroku to DigitalOcean.  Provisioning up the server with Node.js, Nginx, LetsEncrypt and PM2.',
    html: '<h1>html</h1>',
    images: {
      featured: {
