...
**[React Amsterdam](https://react.amsterdam)** is a full day conference on all things React. The biggest conference I've ever been with more than 1000 developers from all across the 🌍. I went with two workmates from **Ulabox** [@sospedra_r](https://twitter.com/sospedra_r) and [@juanmaorta](http://twitter.com/juanmaorta). The event was organized in two tracks: **React** & **React Native**.
